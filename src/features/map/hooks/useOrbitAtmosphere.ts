...
export const ATMOSPHERE_THEMES: Record<AtmosphereState, AtmosphereTheme> = {
    STORM: {
        ...
        gradientColors: ['#1F1818', '#2D2222', '#3D2D2D'],
        mistEnabled: true,
    ...
    MIST: {
        ...
        gradientColors: ['#1E1E1E', '#2A2A2A', '#383838'],
        mistEnabled: true,
    ...
    DRAIN: {
        ...
        gradientColors: ['#161B22', '#222A35', '#2E3B4B'],
        mistEnabled: true,
    ...
    SURGE: {
        ...
        gradientColors: ['#172017', '#1E2B1E', '#2B3C2B'],
        mistEnabled: false,
    ...
    BREEZE: {
        ...
        gradientColors: ['#F4FAF5', '#E9F5EA', '#D6EFE0'],
        mistEnabled: false,
        mistColor: 'transparent',
    ...
    SUPERNOVA: {
        ...
        gradientColors: ['#FFFDF0', '#FFFBE8', '#FFF7CD'],
        mistEnabled: false,
        mistColor: 'transparent',
        turbulenceAmplitude: 0.1,
        turbulenceSpeed: 15,
